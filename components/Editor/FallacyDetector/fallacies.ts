...
export const logicalFallaciesData: LogicalFallacy[] = [
  ...
  },
  {
    ...
    rebuttal: "<p>Politely correct their misrepresentation of your argument. Clearly restate your original point and explain how it differs from the 'straw man' they've created. You could say, \"That's not quite what I was arguing. My actual point is...\"</p>",
  ...
  },
  {
    ...
    rebuttal: "<p>Point out that they are changing the definition of the group to exclude your counterexample, which is an attempt to make their generalization unfalsifiable. You could ask, \"How are you defining a 'true X' now, and why does my example not fit that new definition?\"</p>",
  ...
  },
  {
    ...
    name: 'The Fallacy (Argument from Fallacy)',
  ...
  },
  {
    ...
    name: 'Middle Ground (Argument to Moderation)',
